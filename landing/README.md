# ColorChord theory landing (static)

Deploy target: Cloudflare Pages project `colorchord-jonbailey`
Live: https://colorchord.jonbailey.xyz/

Not part of the Living Spectrum Vite/Nitro build. Deploy with:
